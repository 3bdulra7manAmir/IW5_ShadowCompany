...
_id_74C1()
{
    ...
    //level._id_45FA["player_legs"] = "viewlegs_generic"; //HERE Consider Error Remove Maybe // //

    var_6 = maps\_utility::_id_1287( "player_legs" );
    var_6 setmodel( "viewlegs_generic" );
